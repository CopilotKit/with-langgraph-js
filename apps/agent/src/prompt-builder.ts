/**
 * A2UI Protocol specification and prompt builder
 * Converted from Python: src/prompt_builder.py
 */
...
/**
 * Constructs the prompt for a text-only agent with A2UI capabilities.
 */
export function addA2ui(originalPrompt: string): string {
  return `
    You will be asked to demonstrate A2UI. When asked, give a simple example of A2UI from this spec:
    ${A2UI_SCHEMA}
